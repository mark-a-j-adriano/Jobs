    ...
    */
        ...
        DataFactory.getTask($stateParams.taskID, 'studio').then(
            ...
            function (response) {
                ...
                if (vm.currentUser.canEdit == '') {
                    ...
                    if (_.isUndefined(vm.task.final_ad_spend) || _.isNull(vm.task.final_ad_spend) || _.isEmpty(vm.task.final_ad_spend) || vm.task.final_ad_spend == '') {
                    } else {
                        vm.task.final_ad_spend = parseFloat(vm.task.final_ad_spend);
                    }

                    if (_.isUndefined(vm.task.final_production_cost) || _.isNull(vm.task.final_production_cost) || _.isEmpty(vm.task.final_production_cost) || vm.task.final_production_cost == '') {
                    } else {
    ...
    vm.approveArtwork = function () {
        ...
        if (hasTBD) {
            ...
            if (_.isUndefined(vm.task.final_ad_spend) || _.isNull(vm.task.final_ad_spend) || vm.task.final_ad_spend == "") {
            ...
            if (_.isUndefined(vm.task.final_production_cost) || _.isNull(vm.task.final_production_cost) || vm.task.final_production_cost == "") {
                toastr.error("Please update final ad spend.", { closeButton: true });
                ...
                if (parseFloat(vm.task.final_production_cost) == parseFloat(vm.task.production_cost)) {
                    toastr.error("Please update final production cost.", { closeButton: true });
                }
            }
