app.controller("productsCtrl", function($scope, $modal, $filter, Data) {
  ...
  $scope.deleteProduct = function(product) {
    if (confirm("Are you sure to remove the product")) {
      Data.delete("products/" + product.id).then(function(result) {
        $scope.products = _.without(
          $scope.products,
          _.findWhere($scope.products, { id: product.id })
        );
      });
    }
  };
  ...
  $scope.columns = [
    ...
    { text: "System", predicate: "name", sortable: true },
    { text: "Domain", predicate: "price", sortable: true },
    { text: "Server", predicate: "stock", sortable: true },
    {
      text: "No. of User IDs",
      predicate: "packing",
      reverse: true,
